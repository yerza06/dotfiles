...
// Flexoki palette, identical to the one the status bar and the notification
// popups use, so the launcher reads as part of the same shell.
Singleton {
    id: root
    ...
    // Backdrop behind the launcher card.
